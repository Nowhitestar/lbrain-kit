...
- The extension attempts at most 256 attachments and never invokes Chrome's unbounded MHTML Page Capture API. Extension and Host both enforce 256 MiB per-media and 512 MiB total stream limits; sequential bounded reads and repeated 512 MiB disk-reserve checks cover receipt, staging conversion, and final writes.
