...
- Extension and Host both enforce 256 MiB per-media and 512 MiB total stream limits; sequential bounded reads and a 512 MiB final disk reserve prevent page-driven memory or disk exhaustion.
...
- The three media-limit and disk-reserve regressions passed again after the final oversized-response cancellation guard.
