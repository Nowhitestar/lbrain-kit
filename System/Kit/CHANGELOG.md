...
- Preserved authenticated articles, WeChat articles, X Articles and first-author Threads, direct PDFs, non-video document attachments, images, audio, webpage subtitles/transcripts, video origin links, and sanitized offline HTML snapshots for non-article pages; video binaries and unbounded MHTML generation remain excluded, captures attempt at most 256 attachments, enforce 256 MiB per media file and 512 MiB total, and preserve a 512 MiB disk reserve throughout staging and final writes.
